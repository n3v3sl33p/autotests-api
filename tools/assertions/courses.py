...
from fixtures.courses import CreateCourseResponseSchema
from tools.assertions.base import assert_equal
from tools.assertions.errors import assert_length
from tools.assertions.files import assert_file
from tools.assertions.users import assert_users
...
def assert_course(actual: CourseSchema, expected: CourseSchema):
    ...
    assert_users(actual.created_by_user, expected.created_by_user)
...
def assert_create_course_response(
    ...
    assert_equal(response.course.preview_file.id, request.file_id, "preview_file_id")
    assert_equal(
